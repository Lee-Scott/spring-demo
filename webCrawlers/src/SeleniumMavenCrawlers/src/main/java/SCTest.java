...
public class SCTest {
    ...
    public void sC() {
        ...
        //driver.manage().window().setSize(new Dimension(1081, 1881));
        ...
        driver.findElement(By.cssSelector(".playControls__next")).click();
        {
            WebElement element = driver.findElement(By.cssSelector(".playControls__next"));
        ...
        js.executeScript("window.scrollTo(0,425.77777099609375)");
        driver.close();
    }
}
